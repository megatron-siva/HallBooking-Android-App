...
public class Approvals extends AppCompatActivity {
    ...
    private static Approvals instance;
    private RecyclerView mRecyclerView;
    private ExampleAdapterApprovals mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        top.setText("APPROVALS");
        instance=this;
        String URLline=ip+"/myapprovals";
        ...
        final JsonObjectRequest request = new JsonObjectRequest(com.android.volley.Request.Method.POST, URLline,jsonObj,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Approvals.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void buildRecyclerView() {
        ...
        mAdapter = new ExampleAdapterApprovals(mExampleList);

        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerView.setAdapter(mAdapter);

        mAdapter.setOnItemClickListener(new ExampleAdapterApprovals.OnItemClickListener() {
            @Override
    ...
    public void request(final String position,final ExampleAdapterApprovals.OnItemClickListener listener){
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Toast.makeText(Approvals.this,text,Toast.LENGTH_LONG).show();
    ...
    public static Approvals getInstance() {
        return instance;
    }

    public void RejectMethod(final String position,final ExampleAdapterApprovals.OnItemClickListener listener) {
        AlertDialog.Builder mbuilder = new AlertDialog.Builder(Approvals.this);
    ...
    public void AcceptMethod(final String position,final ExampleAdapterApprovals.OnItemClickListener listener) {
        AlertDialog.Builder mbuilder = new AlertDialog.Builder(Approvals.this);
        final View mview = getLayoutInflater().inflate(R.layout.layout_dialog, null);
        TextView tv=(TextView)mview.findViewById(R.id.poptv);
